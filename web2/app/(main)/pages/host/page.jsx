                ...
                <div className="card">
                    ...
                    <Toolbar className="mb-4"
                             start={<>
                                 ...
                                 <FileUpload mode="basic" accept="image/*" maxFileSize={1000000} chooseLabel="导入"
                                             className="mr-2 inline-block"/>
                                 <Button label="导出" icon="pi pi-upload" severity="help" onClick={exportCSV}/>
                             </>}></Toolbar>
                    ...
                    <Dialog visible={productDialog} style={{width: '450px'}} header="Product Details" modal
                        ...
                        {product.image &&
                            <img src={`/demo/images/product/${product.image}`} alt={product.image} width="150"
