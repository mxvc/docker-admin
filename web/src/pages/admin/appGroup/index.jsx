...
import {ButtonList,HttpUtil, Page,ProTable} from "@tmgg/tmgg-base";
...
export default class extends React.Component {
  ...
  onFinish = values => {
    HttpUtil.post( 'appGroup/save', values).then(rs => {
  ...
  handleDelete = record => {
    HttpUtil.get( 'appGroup/delete', {id:record.id}).then(rs => {
      this.tableRef.current.reload()
    })
  }
  ...
  render() {
    return <Page>
      <ProTable
          ...
          request={(params) => HttpUtil.pageData('appGroup/page', params)}
